/*
package it.unisalento.pas.monitoraggio.cassonetto;
...
import it.unisalento.pas.monitoraggio.restcontrollers.CassonettoRestControllers;
...
public class CassonettoRestControllersTest {
    ...
    public void testPostMethod() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("http://localhost:8080/monitorare/cassonetti/aggiungi")
    ...
    public void testGetMethod() throws Exception {
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("http://localhost:8080/monitorare/cassonetti/lista"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andReturn();
    ...
    public void testPutMethod() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.put("http://localhost:8080/monitorare/cassonetti/aggiornaStato/" + cassonetto.getLuogo() + "/" + cassonetto.getStato())
