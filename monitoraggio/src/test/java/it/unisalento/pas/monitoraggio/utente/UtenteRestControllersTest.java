package it.unisalento.pas.monitoraggio.utente;
...
import it.unisalento.pas.monitoraggio.restcontrollers.UtenteRestControllers;
...
public class UtenteRestControllersTest {
    ...
    public void testPostMethod() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("http://localhost:8080/monitorare/utenti/aggiungi")
    ...
    public void testGetMethod() throws Exception {
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("http://localhost:8080/monitorare/utenti/lista"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andReturn();
