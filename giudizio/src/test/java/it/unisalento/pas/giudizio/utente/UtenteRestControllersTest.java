package it.unisalento.pas.giudizio.utente;
...
import it.unisalento.pas.giudizio.restcontrollers.UtenteRestControllers;
...
public class UtenteRestControllersTest {
    ...
    public void testPostMethod() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("http://localhost:8080/giudizio/utenti/aggiungi")
    ...
    public void testGetMethod() throws Exception {
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("http://localhost:8080/giudizio/utenti/lista"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andReturn();
