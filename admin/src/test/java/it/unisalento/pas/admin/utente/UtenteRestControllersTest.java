package it.unisalento.pas.admin.utente;
...
import it.unisalento.pas.admin.restcontrollers.UtenteRestControllers;
...
public class UtenteRestControllersTest {
    ...
    public void testPostMethod() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("http://localhost:8080/admin/utenti/aggiungi")
    ...
    public void testGetMethod() throws Exception {
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("http://localhost:8080/admin/utenti/lista"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andReturn();
